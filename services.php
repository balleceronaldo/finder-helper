...
<head>
  ...
  <title>Finder Helper | Our Services</title>
...
<div class="mt-5 header-img fade-in">
  <img class="img-fluid" src="./img/img3.webp" alt="">
</div>
...
<div class="container mt-5 col-m-7 text-center section-2">
  <p>We help families find missing family members and friends. We coordinate with the DSWD, the PNP, and the local government. When you register, you can help by reporting relevant information. You can also view all the reported missing persons after registration.</p>
</div>


<div class="container text-center my-5 ">
<a href="./add.php"><button type="button" class="fw-normal btn btn-primary btn-1">REPORT INFORMATION</button></a>
</div>
<div class="container mt-5 col-m-7 text-center section-2">
  <p>Access and report data using any device such as phone, tablet, laptop or pc. It will require internet connection to use this platform. You must also register and login in order to report data.</p>
</div>

<div class="section-3 mt-5">
  <img class="img-fluid" src="./img/img5.webp" alt="">
</div>
