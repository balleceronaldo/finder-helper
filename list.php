...
$sql = "SELECT * FROM missing ORDER BY id DESC";
...
<nav class="navbar navbar-expand-md navbar-light bg-light fixed-top py-3 top" id="navBar" name="top">
  ...
  <div class="container pt-5">
    <br><br>
 <h1 class="top">Reported Missing Person List</h1>
 <br>
 <form class="row row-cols-sm-auto g-3" class="index-form" action="result.php" method="GET">
<div class="col-12">
